...
# 이전 예제와 다르게 bidirectional=True
cell = nn.RNN(word_dim, hidden_dim, batch_first=True, num_layers=3, bidirectional=True)

# rnn_basic 예제에서 total_hidden_states, last hidden_state_t 라고...
outputs, _status = cell(inputs)

# (batch, sequence, hidden * 2) 입력에서 input이 hidden으로만 바뀌었다...
